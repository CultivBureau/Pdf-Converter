        ...
        <div className="relative">
          ...
          <div className="relative">
            <input
              ...
              className="w-full pl-14 pr-6 py-4 bg-gradient-to-br from-gray-50 to-[#C4B454]/5 border-2 border-gray-300 rounded-xl focus:ring-4 focus:ring-[#C4B454]/30 focus:border-[#C4B454] focus:bg-white transition-all duration-200 text-gray-900 font-medium placeholder:text-gray-400 shadow-sm hover:shadow-md"
            />
